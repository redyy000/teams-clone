...
def test_successful():
    ...
    owner = auth_register_v1('channelowner@gmail.com', 'testpassword1', 'first', 'last')
    user1 = auth_register_v1('user1@gmail.com', 'testpassword', 'firstname', 'lastname')
    new_channel1 = channels_create_v1(owner['auth_user_id'], 'New Channel 1', True)
    channel_join_v1(user1['auth_user_id'], new_channel1['channel_id']) # joins user1 to channel
...
def test_invalid_channel_id(): #PASSED 8:33
    ...
    validuser1 = auth_register_v1('user1@gmail.com', 'testpassword1', 'first', 'last')
    validuser2 = auth_register_v1('user2@gmail.com', 'testpassword2', 'first2', 'last2')
...
def test_non_member(): #Assuming a valid auth_user_id and channel_id
    clear_v1()
    member_user = auth_register_v1('member@gmail.com', 'testpasswordmem', 'firstmem', 'lastmem')
    non_member_user = auth_register_v1('nonmember@gmail.com', 'testpasswordnon', 'firstnon', 'lastnon')
    channel_id1 = channels_create_v1(member_user['auth_user_id'], 'Test Channel 1', True)
    with pytest.raises(AccessError):
        assert channel_details_v1(non_member_user['auth_user_id'], channel_id1['channel_id'])
...
def test_invalid_auth_user_id(): #PASSED 8:25 // not passed when commenting out invalid Id from create
    with pytest.raises(AccessError):
        clear_v1()
        test_user = auth_register_v1('testuser@gmail.com', 'testpassword5', 'first5', 'last5')
        channel_id2 = channels_create_v1(test_user["auth_user_id"], "Test Channel2", True)

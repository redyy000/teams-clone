...
def users_all_success_test():
    ...
    users_list = {
        'users' : [
                user.user_profile_v1(user_one_info['token'], user_one_info['auth_user_id'])['user'],
                user.user_profile_v1(user_two_info['token'], user_two_info['auth_user_id'])['user'],
                user.user_profile_v1(user_three_info['token'], user_three_info['auth_user_id'])['user']
            ]
    }
